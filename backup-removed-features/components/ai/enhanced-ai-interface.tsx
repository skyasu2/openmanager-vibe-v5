        ...
        <div className='flex items-center space-x-3 mb-3'>
          ...
          <div>
            ...
            <p className='text-blue-100'>
              MCP 문서 활용 극대화 + TensorFlow.js 하이브리드
            </p>
          </div>
        </div>
            ...
            <div className='flex items-center space-x-3'>
              ...
              <div>
                ...
                <p className='text-blue-700 text-sm'>
                  MCP 문서 검색 → 의도 분석 → TensorFlow.js 예측 → 컨텍스트 답변
                  생성
                </p>
              </div>
            </div>
      ...
      <AnimatePresence>
        {result && (
          ...
          >
              ...
              <div className='grid grid-cols-2 md:grid-cols-4 gap-4 text-sm'>
                <div className='flex items-center space-x-2'>
                  ...
                  <span className='font-medium'>
                    의도: {result.metadata.intentDetected}
                  </span>
                </div>
                <div className='flex items-center space-x-2'>
                ...
                <div className='flex items-center space-x-2'>
                  ...
                  <span>
                    Render: {renderRenderStatus(result.result.renderStatus)}
                  </span>
                </div>
                <div className='flex items-center space-x-2'>
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: result.result.answer
                      ...
                      .replace(
                        /### (.*?)$/gm,
                        '<h3 class="text-md font-medium mt-3 mb-1">$1</h3>'
                      )
            ...
            {/* TensorFlow.js 예측 결과 */}
            {result.result.tensorflowPredictions &&
              Object.keys(result.result.tensorflowPredictions).length > 0 && (
                <div className='bg-white rounded-lg shadow-lg border border-gray-200 p-6'>
                  <h3 className='text-lg font-semibold text-gray-900 mb-4 flex items-center space-x-2'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                <div className='bg-blue-50 rounded-lg p-4 text-center'>
                  <div className='text-2xl font-bold text-blue-600'>
                    {result.performance.aiProcessingTime}ms
                  </div>
                  <div className='text-blue-700 text-sm'>AI 처리 시간</div>
                </div>
                <div className='bg-green-50 rounded-lg p-4 text-center'>
                  <div className='text-2xl font-bold text-green-600'>
                    {result.performance.totalApiTime}ms
                  </div>
