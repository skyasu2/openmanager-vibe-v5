    ...
    switch (args[0]) {
        ...
        case 'activate':
            if (args[1]) {
                ...
                console.log('사용법: node development/scripts/mcp-health-check.js activate [서버이름]');
            }
            break;
        case 'deactivate':
            if (args[1]) {
                ...
                console.log('사용법: node development/scripts/mcp-health-check.js deactivate [서버이름] [이유]');
            }
            break;
        default:
            ...
            console.log('====================');
            console.log('사용법:');
            console.log('  node development/scripts/mcp-health-check.js status     # 전체 상태 확인');
            console.log('  node development/scripts/mcp-health-check.js activate [서버이름]   # 서버 활성화');
            console.log('  node development/scripts/mcp-health-check.js deactivate [서버이름] # 서버 비활성화');
            console.log('');
            console.log('예시:');
