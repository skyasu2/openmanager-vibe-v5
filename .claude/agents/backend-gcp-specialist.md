...
tools: mcp__filesystem__*, mcp__github__*, Bash, Read, Write, Grep, mcp__context7__*, mcp__tavily-remote__*, mcp__sequential-thinking__*
---
...
- **mcp**tavily-remote**\***: For researching GCP updates and serverless patterns
