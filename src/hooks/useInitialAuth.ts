...
export function useInitialAuth() {
  ...
  }, [pathname]); // router 객체 의존성 제거하여 Vercel Edge Runtime 호환성 확보
  ...
  }, []); // updateState, safeRedirect 함수 의존성 제거하여 Vercel Edge Runtime 호환성 확보
  ...
  const retry = useCallback(() => {
    ...
    initializeAuth();
  }, []); // initializeAuth 함수 의존성 제거하여 Vercel Edge Runtime 호환성 확보
