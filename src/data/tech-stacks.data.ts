...
export const TECH_STACKS_DATA: Record<string, TechItem[]> = {
  'mcp-ai-engine': [
    {
      ...
      category: 'ai',
      importance: 'critical',
      description: '로컬 AI 기본 실시간 어시스턴트 사이드바',
      implementation: '모든 기능 로컬 AI로 처리, 선택적으로 Google AI 모드 전환 가능',
      version: 'v5.66.22',
      status: 'active',
      icon: '🤖',
  ...
  'tech-stack': [
    ...
    },
    {
      ...
      implementation: '데이터 캐싱, 백그라운드 리페칭, 옵티미스틱 업데이트 지원',
      version: '5.66.1',
      status: 'active',
      icon: '🔄',
      tags: ['상태관리', '오픈소스', '서버상태'],
    ...
    },
    {
      ...
      category: 'framework',
      importance: 'medium',
      description: 'HTTP 클라이언트와 데이터 페칭 라이브러리',
      implementation: 'API 통신 및 실시간 데이터 동기화, 자동 재검증',
      version: 'axios 1.7.3, swr 2.2.5',
      status: 'active',
      icon: '🌐',
      tags: ['HTTP', '오픈소스', '데이터페칭'],
      type: 'opensource',
    },
    {
      name: 'Sonner',
      category: 'ui',
      importance: 'medium',
      description: '모던한 토스트 알림 라이브러리',
      implementation: '성공/에러/경고 알림, 프로미스 기반 토스트, 커스텀 렌더링 지원',
      version: '1.5.0',
      status: 'active',
      icon: '🔔',
      tags: ['알림', '오픈소스', 'UI피드백'],
    ...
    },
    {
      ...
      category: 'ui',
      importance: 'medium',
      description: '다크모드/라이트모드 테마 전환 라이브러리',
      implementation: '시스템 설정 연동, localStorage 저장, SSR 지원, 플리커 없는 전환',
      version: '0.3.0',
      status: 'active',
      icon: '🌓',
      tags: ['다크모드', '오픈소스', 'UI테마'],
    ...
    },
    {
      ...
      category: 'framework',
      importance: 'high',
      description: '고성능 폼 상태 관리 라이브러리',
      implementation: '비제어 컴포넌트 기반, 유효성 검사, 에러 처리, TypeScript 완벽 지원',
      version: '7.52.2',
      status: 'active',
      icon: '📝',
      tags: ['폼관리', '오픈소스', '유효성검사'],
    ...
    },
    {
      ...
      category: 'ui',
      importance: 'medium',
      description: '경량 토스트 알림 라이브러리 (Sonner와 함께 사용)',
      implementation: '핫키 지원, 프로미스 기반 알림, 커스텀 스타일링, 접근성 지원',
      version: '2.4.1',
      status: 'active',
      icon: '🍞',
      tags: ['알림', '오픈소스', 'UI피드백'],
    ...
    },
    {
      ...
      category: 'utility',
      importance: 'medium',
      description: '모던 JavaScript 날짜 유틸리티 라이브러리',
      implementation: '200+ 함수, Tree-shaking 지원, 한국어 로케일, TypeScript 지원',
      version: '3.6.0',
      status: 'active',
      icon: '📅',
      tags: ['날짜처리', '오픈소스', '유틸리티'],
    ...
    },
    {
      ...
      category: 'framework',
      importance: 'medium',
      description: 'MDX 콘텐츠를 동적으로 렌더링',
      implementation: '외부 MDX 파일 로드, 컴포넌트 주입, 서버/클라이언트 렌더링 지원',
      version: '5.0.0',
      status: 'active',
      icon: '📄',
      tags: ['MDX', '오픈소스', '콘텐츠'],
    ...
    },
    {
      ...
      category: 'ui',
      importance: 'low',
      description: '터치 친화적 캐러셀 라이브러리',
      implementation: '모바일 스와이프, 무한 루프, 자동 재생, React 통합',
      version: '8.1.8',
      status: 'active',
      icon: '🎠',
      tags: ['캐러셀', '오픈소스', 'UI컴포넌트'],
      type: 'opensource',
    },
  ],
  'cursor-ai': [
