  ...
  'ai-assistant-pro': [
    {
      ...
      importance: 'critical',
      description:
        'LangGraph 기반 A2A(Agent-to-Agent) 아키텍처의 핵심 프레임워크',
      implementation:
        'Supervisor-Worker 패턴으로 Gemini(지휘관)와 Groq(실행자)가 유기적으로 협업',
      version: 'LangGraph 0.2',
      status: 'active',
      icon: '🕸️',
      tags: ['LangGraph', 'Multi-Agent', 'A2A'],
      type: 'opensource',
    },
    {
      name: 'Google Gemini 2.5 (Supervisor)',
      category: 'ai',
      importance: 'critical',
      description:
        '시스템의 "두뇌" - 복잡한 추론과 작업 계획을 담당하는 메인 에이전트',
      implementation:
        'Gemini 2.5 Pro(심층 분석)와 Flash(빠른 응답)를 상황에 맞게 자동 전환',
      version: 'Gemini 2.5',
      status: 'active',
      icon: '🧠',
      tags: ['Supervisor', 'Reasoning', 'Google AI'],
      type: 'commercial',
      aiType: 'google-api',
    },
    {
      name: 'Groq LPU + Llama 3 (Worker)',
      category: 'ai',
      importance: 'critical',
      description: '시스템의 "행동대장" - 0.1초 내 도구 실행과 데이터 처리',
      implementation:
        'Groq LPU(500 Tokens/s)로 DB 조회, 검색 등 실제 도구를 초고속 실행',
      version: 'Llama 3.1 70B',
      status: 'active',
      icon: '⚡',
      tags: ['Worker', 'Tool Use', 'Speed'],
      type: 'commercial',
    },
    {
      ...
      category: 'database',
      importance: 'high',
      description: '단 하나의 공식 MCP로 AI가 Supabase에 직접 연결',
      implementation:
        '@modelcontextprotocol/server-postgres 기반, 복잡한 설정 없이 SQL 실행',
      version: 'MCP 1.0',
      status: 'active',
      icon: '🔌',
    ...
    },
    {
      ...
      category: 'database',
      importance: 'high',
      description: '프로젝트 문서와 히스토리를 AI가 참조하는 지식 베이스',
      implementation: 'PostgreSQL pgVector로 임베딩 검색, 맥락 인식 답변 생성',
      status: 'active',
      icon: '📚',
    ...
    },
    {
      ...
      category: 'language',
      importance: 'high',
      description: '"CPU 높은 서버?" 같은 자연어 질문을 Gemini가 이해',
      implementation:
        'Gemini 2.5의 다국어 지원으로 한국어 쿼리를 정확하게 파싱',
      status: 'active',
      icon: '🇰🇷',
      tags: ['한국어', 'NLP', 'Gemini'],
      type: 'custom',
    ...
    },
    {
      ...
      category: 'ai',
      importance: 'high',
      description: '15초마다 갱신되는 메트릭 데이터를 AI가 실시간 분석',
      implementation:
        'Groq Worker가 메트릭 조회 도구를 호출, Gemini가 결과 해석',
      status: 'active',
      icon: '📊',
      tags: ['실시간', '메트릭', 'AI분석'],
      type: 'custom',
    ...
    {
      name: '이상 징후 감지 & 자동 보고서',
      category: 'ai',
      importance: 'high',
      description: 'CPU/메모리 급증 감지 및 장애 보고서 자동 생성',
      implementation:
        'Analyst 에이전트가 패턴 분석, Writer 에이전트가 보고서 작성',
      status: 'active',
      icon: '🚨',
      tags: ['이상감지', '자동보고서', 'Multi-Agent'],
      type: 'custom',
    },
  ],
  'fullstack-ecosystem': [
