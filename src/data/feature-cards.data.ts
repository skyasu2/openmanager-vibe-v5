...
export const FEATURE_CARDS_DATA: FeatureCard[] = [
  {
    ...
    detailedContent: {
      overview: `2-AI 모드 시스템 완성! LOCAL 모드(GCP Functions + Supabase RAG)와 GOOGLE_AI 모드(Gemini 2.5)로 실시간 서버 분석과 한국어 자연어 처리를 제공합니다.`,
      features: [
        '🌐 GCP Functions 백엔드: 서버리스 AI 엔진, 한국어 NLP 처리, 확장 가능한 마이크로서비스 아키텍처',
        '🤖 LOCAL 모드: GCP Functions + Supabase RAG 통합, 무료 티어 활용, 기본 쿼리 빠른 응답',
        '🧠 GOOGLE_AI 모드: Gemini 2.5 모델군 (Flash-Lite/Flash/Pro), 자연어 질의 지원, 고급 추론 기능',
  ...
  },
  {
    ...
    detailedContent: {
      ...
      features: [
        ...
        '☁️ GCP Functions 플랫폼: 서버리스 AI 백엔드, 한국어 NLP 처리, 확장 가능한 마이크로서비스 아키텍처',
