...
export const FEATURE_CARDS_DATA: FeatureCard[] = [
  {
    ...
    detailedContent: {
      overview: `v5.66.32 - AI 기반 서버 모니터링 어시스턴트! 대시보드 사이드바에서 한국어로 서버 상태를 분석하고 즉시 답변받으세요. Supabase pgVector와 GCP Functions로 구현된 강력한 AI 시스템.`,
      features: [
        '🤖 하이브리드 AI 엔진: Supabase pgVector + GCP Functions + Google AI 통합',
        '📊 서버 상태 분석: 실시간 메트릭 분석 및 자연어 답변 제공',
        '🚨 이상 징후 감지: ML 기반 패턴 분석으로 예방적 알림',
        '🇰🇷 한국어 자연어 질의: "CPU 높은 서버?", "메모리 부족한 서버?" 등',
        '🗄️ pgVector 벡터 검색: 126ms 응답 속도, 7.5x 성능 향상 달성',
        '🆓 완전 무료 운영: Supabase + GCP Functions 무료 티어 100% 활용',
        '🌍 구글 AI 옵션: 선택적으로 Gemini 2.0 Flash 고급 분석 전환 가능',
      ],
      technologies: [
        'Supabase pgVector',
        'GCP Cloud Functions',
  ...
  },
  {
    ...
    detailedContent: {
      overview: `v5.66.22 - 프로덕션급 기술 스택! TypeScript strict mode, 실시간 차트 시각화, 애니메이션 효과, 테스트 자동화로 완성도 높은 애플리케이션 구현.`,
      features: [
        ...
        '🔔 Radix UI + Sonner: 접근성 높은 UI 컴포넌트와 토스트 알림',
      ],
      technologies: [
        'Next.js 15.4.5',
        'React 18.3.1',
