...
export type ClusterStatus = 'healthy' | 'degraded' | 'critical' | 'scaling';
...
export type ServiceStatus = 'active' | 'inactive' | 'failed' | 'disabled';
...
export type ConnectionType = 'ethernet' | 'wireless' | 'vpn' | 'direct';
...
export type EffectTarget = 'cpu' | 'memory' | 'disk' | 'network' | 'service';
...
export type TriggerCondition = 'time' | 'metric-threshold' | 'event' | 'manual';
...
export type EnvironmentMode = 'local' | 'premium' | 'basic' | 'minimal';
