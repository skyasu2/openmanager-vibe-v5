...
export type ServerStatus = 'healthy' | 'warning' | 'critical' | 'maintenance';
export type ServerEnvironment = 'on-premise' | 'aws' | 'kubernetes' | 'gcp' | 'azure';
export type ServerRole = 'web' | 'api' | 'database' | 'cache' | 'storage' | 'k8s-control' | 'k8s-worker' | 'load-balancer' | 'backup';
