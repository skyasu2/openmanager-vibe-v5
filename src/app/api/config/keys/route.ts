            ...
            case 'status': {
                const services = [
                    ...
                    },
                    {
                        ...
                        status: 'active' as const,
                        source: 'encrypted' as const,
                        preview: 'AIzaSyABC2WATlHIG0Kd-Oj4JSL6wJoq...',
                        lastChecked: timestamp
                    },
                    {
                        ...
                        status: 'active' as const,
                        source: 'encrypted' as const,
                        preview: 'https://hooks.slack.com/services/T090J1TTD34...',
                        lastChecked: timestamp
                    }
                ];
                ...
                const summary = {
                    ...
                    successRate: Math.round((services.filter(s => s.status === 'active').length / services.length) * 100)
                };
