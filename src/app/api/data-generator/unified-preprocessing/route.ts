...
export async function GET(request: NextRequest) {
    ...
    try {
        ...
        console.log(`🔄 통합 전처리 API 요청: purpose=${purpose}, options=${JSON.stringify(options)}`);
        ...
        console.log(`✅ 통합 전처리 API 응답: ${responseTime}ms, 캐시=${result.metadata.cacheHit ? 'HIT' : 'MISS'}`);
...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        console.log(`🔄 통합 전처리 API POST 요청: purpose=${purpose}, options=${JSON.stringify(options)}`);
        ...
        console.log(`✅ 통합 전처리 API POST 응답: ${responseTime}ms, 캐시=${result.metadata.cacheHit ? 'HIT' : 'MISS'}`);
