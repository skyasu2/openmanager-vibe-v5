        ...
        switch (action) {
            ...
            case 'validated':
                ...
                try {
                    ...
                    console.log('✅ 구글 타임서버 연결 성공:', validatedTime.latency + 'ms');
                } catch (error) {
                ...
                if (!validatedTime) {
                    try {
                        ...
                        console.log('✅ 네이버 타임서버 연결 성공:', validatedTime.latency + 'ms');
                    } catch (error) {
            ...
            case 'verify-date':
                ...
                const todayKST = today.toLocaleDateString('ko-KR', { timeZone: 'Asia/Seoul' });
                const expectedDate = '2025-06-29';

                const isCorrectDate = todayKST.includes('2025') &&
                    todayKST.includes('6') &&
