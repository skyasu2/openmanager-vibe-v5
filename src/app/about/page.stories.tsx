...
export const Default: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: '기본적인 개발과정 페이지입니다. 프로젝트 통계와 3개 주요 섹션이 표시됩니다.',
            },
        },
    },
};
...
export const MobileView: Story = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                story: '모바일 화면에서의 개발과정 페이지입니다. 카드들이 세로로 배치됩니다.',
            },
        },
    },
};
...
export const DesktopWideView: Story = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                story: '데스크톱 와이드 화면에서의 개발과정 페이지입니다. 모든 요소가 최적화되어 표시됩니다.',
            },
        },
    },
};
...
export const ContentSectionsFocus: Story = {
    ...
    parameters: {
        docs: {
            description: {
                story: '핵심 기술, 주요 성과, 운영 환경 섹션들을 포커스하여 확인할 수 있습니다.',
            },
        },
    },
}; 