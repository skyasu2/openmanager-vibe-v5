...
export default function MCPMonitoringPage() {
  ...
  const [unifiedAIHealth, setUnifiedAIHealth] = useState<UnifiedAIHealth | null>(null);
  const [isLoading, setIsLoading] = useState(true);
  const [lastUpdated, setLastUpdated] = useState<Date>(new Date());
  const [activeTab, setActiveTab] = useState<'overview' | 'components' | 'performance' | 'cache' | 'analytics'>('overview');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-6">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">MCP 시스템 모니터링</h1>
      ...
      <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-sm font-medium text-gray-600">전체 상태</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-sm font-medium text-gray-600">컴포넌트</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">
                  {systemStatus.overview.healthyComponents}/{systemStatus.overview.totalComponents}
                </div>
            ...
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-sm font-medium text-gray-600">총 질의</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">{systemStatus.performance.totalQueries}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{systemStatus.performance.successRate}%</div>
                <p className="text-sm text-gray-600">평균 응답시간: {systemStatus.performance.avgResponseTime}ms</p>
              </CardContent>
            </Card>
          </div>
        )}
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        <span>응답시간:</span>
                        <span className="font-mono">{systemStatus.components.fastapi.latency}ms</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        <span>초기화:</span>
                        <Badge variant={systemStatus.components.mcp.initialized ? "default" : "secondary"}>
                          {systemStatus.components.mcp.initialized ? '완료' : '대기중'}
                        </Badge>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span>상태:</span>
                        {getStatusBadge(systemStatus.components.keepAlive.status)}
                      </div>
                      <div className="flex justify-between items-center">
                        <span>업타임:</span>
                        <span className="font-mono">
                          {Math.floor(systemStatus.components.keepAlive.uptime / 3600000)}h
                        </span>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex justify-between">
                        <span>총 질의 수:</span>
                        <span className="font-bold">{unifiedAIHealth.stats.totalQueries}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>평균 응답시간:</span>
                        <span className="font-bold">{unifiedAIHealth.stats.avgResponseTime}ms</span>
                      </div>
                      <div className="flex justify-between">
                        <span>성공률:</span>
                        <span className="font-bold">{unifiedAIHealth.stats.successRate}%</span>
                      </div>
                      <div className="flex justify-between">
                        <span>캐시 적중률:</span>
                        <span className="font-bold">{unifiedAIHealth.stats.cacheHitRate}%</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <Alert>
                        ...
                        <AlertDescription>
                          Render 무료 티어에서 실행 중입니다. 
                          15분 비활성화 시 자동 스핀다운됩니다.
                        </AlertDescription>
                      </Alert>
                    </div>
                  </CardContent>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span>상태:</span>
                        {getStatusBadge(systemStatus.components.contexts.basic.status)}
                      </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span>상태:</span>
                        {getStatusBadge(systemStatus.components.contexts.advanced.status)}
                      </div>
                      <div className="flex justify-between items-center">
                        <span>문서 수:</span>
                        <span className="font-bold">{systemStatus.components.contexts.advanced.documentsCount}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span>상태:</span>
                        {getStatusBadge(systemStatus.components.contexts.custom.status)}
                      </div>
                      <div className="flex justify-between items-center">
                        <span>규칙 수:</span>
                        <span className="font-bold">{systemStatus.components.contexts.custom.rulesCount}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-white">메모리 사용량</h3>
                  <HardDrive className="w-5 h-5 text-blue-400" />
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400">사용 중</span>
                    <span className="text-white font-medium">{cacheMetrics.memoryUsage}</span>
                  </div>
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-gray-300">{cacheMetrics.memoryLimit}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-white">저장된 키</h3>
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-400">
                    만료: {cacheMetrics.expiredKeys} | 제거: {cacheMetrics.evictedKeys}
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold text-white">작업 통계</h3>
                  <Activity className="w-5 h-5 text-orange-400" />
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400">읽기</span>
                    <span className="text-green-400">{cacheMetrics.operations.gets.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400">쓰기</span>
                    <span className="text-blue-400">{cacheMetrics.operations.sets.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400">삭제</span>
                    <span className="text-red-400">{cacheMetrics.operations.deletes.toLocaleString()}</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        {activeTab === 'analytics' && (
          <div className="space-y-6">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 opacity-0 group-hover:opacity-100 transition-opacity bg-gray-900 text-white text-xs rounded-lg p-2 whitespace-nowrap z-10">
                        ...
                        <div>성공: {data.success}건 ({successRate.toFixed(1)}%)</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6">
                <h4 className="text-lg font-semibold text-white mb-4">응답 품질 피드백</h4>
                ...
                <div className="space-y-4">
                  ...
                  <div className="w-full bg-gray-700 rounded-full h-2 mt-4">
                    <div className="bg-gradient-to-r from-green-500 to-green-400 h-2 rounded-full" style={{ width: '89.3%' }} />
                  </div>
                </div>
              </div>

              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6">
                <h4 className="text-lg font-semibold text-white mb-4">주요 개선 영역</h4>
