...
export function getCurrentEnvironmentConfig() {
    ...
    return ENCRYPTED_ENV_CONFIG.metadata.ENVIRONMENTS[env as keyof typeof ENCRYPTED_ENV_CONFIG.metadata.ENVIRONMENTS] ||
...
export function getSecurityLevelConfig() {
    ...
    return ENCRYPTED_ENV_CONFIG.metadata.SECURITY_LEVELS[level as keyof typeof ENCRYPTED_ENV_CONFIG.metadata.SECURITY_LEVELS] ||
