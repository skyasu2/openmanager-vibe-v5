...
export class AICache {
  ...
  public static readonly TTL = {
    COMMON_QUERIES: 10 * 60 * 1000, // 일반 쿼리: 10분 (무료 티어 최적화)
    METRICS_DATA: 2 * 60 * 1000, // 메트릭: 2분 (빠른 갱신)
    PREDICTIONS: 10 * 60 * 1000, // 예측: 10분 (무료 티어 최적화)
    MONITORING: 30 * 1000, // 모니터링: 30초 (유지)
    SESSION_DATA: 20 * 60 * 1000, // 세션: 20분 (단축)
    HEALTH_CHECK: 2 * 60 * 1000, // 헬스체크: 2분 (유지)
  };
