...
export function AIEnginesPanel({ className = '' }: AIEnginesPanelProps) {
    ...
    const [aiEnginesStatus, setAiEnginesStatus] = useState<AIEngineStatus[] | null>(null);
                ...
                <CardContent className='space-y-4'>
                    ...
                    <div>
                        ...
                        <Select value={aiTestMode} onValueChange={setAiTestMode}>
                            ...
                            <SelectContent>
                                <SelectItem value='LOCAL'>LOCAL (기본)</SelectItem>
                                <SelectItem value='GOOGLE_AI'>GOOGLE_AI (고급)</SelectItem>
                                <SelectItem value='AUTO'>AUTO (자동선택)</SelectItem>
                            </SelectContent>
                        </Select>
                    </div>
                    ...
                    {aiTestResult && !aiTestLoading && (
                        <Card className={aiTestResult.success ? 'border-green-200' : 'border-red-200'}>
                            <CardHeader>
                                <div className='flex items-center justify-between'>
                                    <CardTitle className='text-lg'>
                                        {aiTestResult.success ? '✅ 성공' : '❌ 실패'}
                                    </CardTitle>
                                    <Badge variant={aiTestResult.success ? 'default' : 'destructive'}>
                                        {aiTestResult.responseTime}ms
                                    </Badge>
                                </div>
                                <CardDescription>
                                    엔진: {aiTestResult.engine}
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
