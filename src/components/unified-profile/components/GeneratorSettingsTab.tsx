...
export function GeneratorSettingsTab({
  generatorConfig,
  isGeneratorLoading: _isGeneratorLoading,
  onGeneratorCheck,
  onServerCountChange,
  onArchitectureChange: _onArchitectureChange,
