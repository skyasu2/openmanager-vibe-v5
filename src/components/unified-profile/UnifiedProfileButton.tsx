                            ...
                            <div className='p-4 border-b border-white/10'>
                                ...
                                <div className='flex items-center justify-between p-3 rounded-lg bg-white/5'>
                                    <div className='flex items-center gap-3'>
                                        <div
                                            className={`p-2 rounded-lg ${aiAgent.isEnabled
                                                    ? 'bg-purple-500/20'
                                                    : 'bg-gray-500/20'
                                                }`}
                                        >
                                            <Bot
                                                className={`w-4 h-4 ${aiAgent.isEnabled
                                                        ? 'text-purple-400'
                                                        : 'text-gray-400'
                                                    }`}
                                            />
                                        ...
                                        <div>
                                            ...
                                            <div
                                                className={`text-xs ${aiAgent.isEnabled
                                                        ? 'text-purple-400'
                                                        : 'text-gray-400'
                                                    }`}
                                            >
    ...
    return (
        <div className='relative'>
            ...
            <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={onClick}
                className={`flex items-center gap-3 p-2 rounded-xl backdrop-blur-sm border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-transparent ${isLocked
