...
> = ({ compact = false }) => {
  ...
  if (isLoading) {
    return (
      <div data-testid="status-skeleton" className="space-y-3 p-4">
  ...
  if (compact) {
    return (
      <div data-testid="compact-layout" className="space-y-1 p-2 text-xs">
        <div className="flex items-center gap-2">
          <Activity
            size={12}
  ...
  return (
    <div className="space-y-4 rounded-lg bg-white/50 p-4 dark:bg-gray-800/50">
      {/* 메인 상태 표시 */}
