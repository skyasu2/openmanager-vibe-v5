...
import { useGoogleAIStatus, useRefreshGoogleAIStatus } from '@/hooks/api/useGoogleAIStatus';
...
export const GoogleAIStatusCard: React.FC<GoogleAIStatusCardProps> = ({
    ...
    const { data: status, isLoading, error, refetch, isRefetching } = useGoogleAIStatus();
                ...
                <div className="p-6 border-b border-gray-100">
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            ...
                            title="새로고침"
                        >
                            <RefreshCw className={`w-4 h-4 ${(isRefetching || isRefreshing) ? 'animate-spin' : ''}`} />
                        </button>
                    </div>
                </div>
