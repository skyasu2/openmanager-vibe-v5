...
export const ServerStatusBadges: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: '서버 모니터링에서 사용되는 다양한 상태 배지들입니다. 이모지와 색상으로 상태를 직관적으로 표현합니다.',
      },
    },
  },
};
...
export const AIStatusBadges: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Multi-AI 엔진의 다양한 상태를 표시하는 배지들입니다. MCP, RAG, Google AI 등의 상태를 시각화합니다.',
      },
    },
  },
};
...
export const MetricLevelBadges: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: '서버 메트릭의 다양한 레벨을 시각적으로 구분하는 배지들입니다. 사용률에 따라 색상이 달라집니다.',
      },
    },
  },
};
...
export const AlertPriorityBadges: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: '시스템 알림과 작업 우선순위를 표시하는 배지들입니다. 긴급도에 따라 시각적 구분이 명확합니다.',
      },
    },
  },
};
...
export const UserRoleBadges: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: '사용자의 권한과 인증 상태를 표시하는 배지들입니다. GitHub OAuth 등 인증 방식도 구분합니다.',
      },
    },
  },
};
...
export const TimeBadges: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: '데이터의 최신성을 표시하는 시간 관련 배지들입니다. 실시간성이 중요한 모니터링 시스템에서 활용됩니다.',
      },
    },
  },
};
...
export const SmallBadges: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: '모바일 화면에서 사용되는 작은 크기의 배지들입니다. 공간 효율성을 고려한 디자인입니다.',
      },
    },
  },
};
...
export const InContextUsage: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: '실제 서버 카드와 AI 엔진 카드에서 배지가 어떻게 사용되는지 보여주는 실사용 예시입니다.',
      },
    },
  },
};
...
export const DarkModeBadges: Story = {
  render: () => (
    <div className="bg-gray-900 p-6 rounded-lg space-y-4">
      <div>
        <h4 className="text-white text-sm font-medium mb-2">서버 상태 (다크모드)</h4>
        <div className="flex gap-2">
          <Badge variant="default" className="bg-green-600">
            온라인
          </Badge>
      ...
      <div>
        <h4 className="text-white text-sm font-medium mb-2">AI 엔진 상태 (다크모드)</h4>
        <div className="flex gap-2">
          <Badge variant="default" className="bg-purple-600">
            활성
          </Badge>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: '다크모드에서의 배지 모양을 확인할 수 있습니다. 색상 대비와 가독성을 검증합니다.',
      },
    },
  },
};