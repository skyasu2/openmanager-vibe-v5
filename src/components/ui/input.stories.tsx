...
export const ServerSearch: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: '서버를 검색할 때 사용되는 입력 필드입니다. 아이콘과 실시간 검색 기능이 포함되어 있습니다.',
      },
    },
  },
};
...
export const AIQueryInput: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'AI 어시스턴트에게 질문할 때 사용되는 입력 필드입니다. 처리 상태에 따른 UI 변화를 포함합니다.',
      },
    },
  },
};
...
export const AuthInputs: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: '사용자 인증에 사용되는 이메일과 비밀번호 입력 필드들입니다. 비밀번호 표시/숨김 기능이 포함되어 있습니다.',
      },
    },
  },
};
...
export const SettingsInputs: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: '서버 모니터링 설정에 사용되는 다양한 입력 필드들입니다. 유효성 검증과 타입별 제한이 적용되어 있습니다.',
      },
    },
  },
};
...
export const ErrorStates: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: '다양한 오류 상태를 표시하는 입력 필드들입니다. 접근성을 고려한 오류 메시지와 시각적 피드백을 제공합니다.',
      },
    },
  },
};
...
export const SuccessState: Story = {
      ...
      <div className="space-y-6 w-80">
        <div className="space-y-2">
          ...
          <Input
            ...
            readOnly
          />
          <p id="success-message" className="text-xs text-green-600 flex items-center gap-1">
  ...
  parameters: {
    docs: {
      description: {
        story: '성공 상태를 표시하는 입력 필드입니다. 연결 테스트 성공 등의 피드백을 제공합니다.',
      },
    },
  },
};
...
export const LoadingState: Story = {
    ...
    return (
      <div className="space-y-6 w-80">
        <div className="space-y-2">
          ...
          />
          <p id="loading-message" className="text-xs text-blue-600 flex items-center gap-1">
            🔄 서버 연결을 확인하고 있습니다...
          </p>
        </div>
      </div>
  ...
  parameters: {
    docs: {
      description: {
        story: '로딩 상태를 표시하는 입력 필드입니다. 서버 연결 확인 등의 비동기 작업 중에 사용됩니다.',
      },
    },
  },
};
...
export const MobileOptimized: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: '모바일 환경에 최적화된 입력 필드들입니다. 적절한 inputMode와 키패드 타입이 설정되어 있습니다.',
      },
    },
  },
};
...
export const DarkMode: Story = {
    ...
    return (
      <div className="bg-gray-900 p-6 rounded-lg">
        <Card className="w-96 bg-gray-800 border-gray-700">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="dark-input" className="text-gray-200 text-sm font-medium">
                서버 이름
              </Label>
              <Input
                id="dark-input"
            ...
            <div className="space-y-2">
              <Label htmlFor="dark-search" className="text-gray-200 text-sm font-medium">
                검색
              </Label>
              <div className="relative">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 h-4 w-4" />
                <Input
                  ...
                  className="bg-gray-700 border-gray-600 text-white placeholder:text-gray-400 focus:border-gray-500 pl-10"
                  aria-label="다크모드 검색"
                />
              </div>
            </div>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: '다크모드에서의 입력 필드 모양을 확인할 수 있습니다. 색상 대비와 가독성을 고려한 디자인입니다.',
      },
    },
  },
};