...
import { createStoryMeta, mockServerStates, storyTitles, a11yLabels } from '../../stories/templates/StoryTemplate';
  ...
  render: () => (
    <Card className="w-80">
      <CardHeader>
        ...
        <CardDescription>OpenManager Vibe v5 기본 카드 컴포넌트입니다.</CardDescription>
      </CardHeader>
      <CardContent>
        <p className="text-sm text-muted-foreground">
          카드 내용이 여기에 표시됩니다. 서버 정보, AI 상태, 메트릭 등을 담을 수 있습니다.
        </p>
      </CardContent>
    </Card>
  ),
...
export const ServerStatusCard: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'AI 모니터링 플랫폼의 핵심인 서버 상태를 표시하는 카드입니다. 실시간 메트릭과 상태 정보를 포함합니다.',
      },
    },
  },
};
...
export const AIEngineCard: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Multi-AI 엔진 상태를 표시하는 카드입니다. MCP, RAG, Google AI 등의 상태와 성능 지표를 포함합니다.',
      },
    },
  },
};
...
export const WarningCard: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: '서버에 문제가 발생했을 때 표시되는 경고 상태 카드입니다. 시각적으로 주의를 끌도록 색상이 변경됩니다.',
      },
    },
  },
};
...
export const OfflineCard: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: '서버가 오프라인 상태일 때 표시되는 카드입니다. 전체적으로 비활성화된 시각적 표현을 제공합니다.',
      },
    },
  },
};
...
export const MobileCard: Story = {
  render: () => (
    <Card className="w-72">
      <CardHeader className="pb-3">
        ...
        <CardDescription className="text-sm">모바일 최적화 버전</CardDescription>
      </CardHeader>
      <CardContent className="space-y-3">
        <div className="flex items-center justify-between">
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: '모바일 화면에 최적화된 카드입니다. 정보 밀도를 조정하고 터치 인터페이스를 고려합니다.',
      },
    },
  },
};
...
export const DarkModeCard: Story = {
    ...
    <div className="bg-gray-900 p-6 rounded-lg">
      <Card className="w-80 bg-gray-800 border-gray-700">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <Badge variant="secondary" className="bg-gray-700 text-gray-300">온라인</Badge>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: '다크모드에서의 카드 모양을 확인할 수 있습니다. 색상 대비와 가독성을 검증합니다.',
      },
    },
  },
};
...
export const AllStatesGrid: Story = {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4">
      ...
      <Card className="w-full border-orange-200 bg-orange-50">
        <CardHeader>
          ...
          <CardDescription className="text-sm text-orange-700">높은 사용률</CardDescription>
        </CardHeader>
        <CardContent>
          <Badge variant="destructive">경고</Badge>
        </CardContent>
      ...
      <Card className="w-full border-red-200 bg-red-50 opacity-75">
        <CardHeader>
          ...
          <CardDescription className="text-sm text-red-700">연결 끊김</CardDescription>
        </CardHeader>
        <CardContent>
          <Badge variant="destructive">오프라인</Badge>
        </CardContent>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: '서버의 모든 상태(온라인, 경고, 오프라인)를 한눈에 비교할 수 있는 그리드 뷰입니다.',
      },
    },
  },
};