...
import ThinkingProcessVisualizer from '../../../src/components/ai/ThinkingProcessVisualizer';
import type { ThinkingStep } from '../../../src/domains/ai-sidebar/types/ai-sidebar-types';
