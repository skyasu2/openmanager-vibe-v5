...
const generateMockLogs = (): LogEntry[] => [
  ...
  },
  {
    ...
    step: '이상 패턴 감지',
    content:
      'Server-07에서 메모리 사용률이 지속적으로 증가하는 패턴을 감지했습니다.',
    duration: 890,
    confidence: 0.87,
  },
  {
  ...
  },
  {
    ...
    step: '실시간 데이터 수집',
    content:
      '프로메테우스로부터 최근 1시간 메트릭 데이터를 수집하고 전처리를 완료했습니다.',
    duration: 2100,
    confidence: 0.98,
  },
  {
    ...
    step: '질의응답 생성',
    content:
      '사용자 질문에 대한 응답을 생성했습니다: "현재 서버 상태는 어떻습니까?"',
    duration: 1800,
    confidence: 0.92,
  },
  {
    ...
    step: '메트릭 분석 실패',
    content:
      'Server-15의 메트릭 데이터 수집 중 연결 오류가 발생했습니다. 재시도 중...',
    duration: 500,
  },
];
              ...
              <div className='flex items-start justify-between mb-2'>
                <div className='flex-1'>
                  <div className='flex items-center gap-2 mb-1'>
                    ...
                    <span
                      className={`flex items-center gap-1 px-2 py-1 rounded-full text-xs border ${getLevelColor(log.level)}`}
                    >
