              ...
              <div className="px-4 pb-4">
                <div className="grid grid-cols-3 gap-3 mb-6">
                  ...
                  >
                    ...
                    <div className="text-2xl font-bold text-blue-600">{server.cpu}%</div>
                  ...
                  >
                    ...
                    <div className="text-2xl font-bold text-purple-600">{server.memory}%</div>
                  ...
                  >
                    ...
                    <div className="text-2xl font-bold text-orange-600">{server.disk}%</div>
                ...
                <div className="space-y-4">
                  ...
                  {server.alerts && server.alerts > 0 && (
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="text-sm font-medium text-red-700">활성 알림</div>
                          <div className="text-lg font-semibold text-red-900">{server.alerts}개</div>
                        </div>
                      </div>
                    </motion.div>
                  )}
                  ...
                  >
                    <h3 className="text-sm font-medium text-gray-700 mb-3">실행 중인 서비스</h3>
