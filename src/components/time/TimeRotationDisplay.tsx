...
export function TimeRotationDisplay({
  ...
  const { timeDisplay, controlState, actions, timeState } = useTimeControl();
  ...
  if (compact) {
    return (
      ...
      >
        ...
        <div className="text-sm font-medium">{timeDisplay.current}</div>
        <div className="text-xs opacity-75">{timeDisplay.cycle}</div>
      </div>
    );
  }
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-sm text-gray-600">
              {timeDisplay.cycle} • {timeDisplay.progress} •{' '}
              {timeDisplay.status}
            </div>
          </div>
        </div>
      ...
      {showControls && isExpanded && (
        <div className="space-y-4 p-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-2">
              <button
                ...
                className="flex flex-col items-center gap-1 rounded-lg bg-yellow-50 px-3 py-2 text-xs transition-colors hover:bg-yellow-100"
              >
              ...
              <button
                ...
                className="flex flex-col items-center gap-1 rounded-lg bg-blue-50 px-3 py-2 text-xs transition-colors hover:bg-blue-100"
              >
              ...
              <button
                ...
                className="flex flex-col items-center gap-1 rounded-lg bg-orange-50 px-3 py-2 text-xs transition-colors hover:bg-orange-100"
              >
              ...
              <button
                ...
                className="flex flex-col items-center gap-1 rounded-lg bg-indigo-50 px-3 py-2 text-xs transition-colors hover:bg-indigo-100"
              >
          ...
          <div className="rounded-lg bg-gray-50 p-3 text-xs text-gray-500">
            <div className="mb-1 font-medium">🕐 시간 시뮬레이션 정보</div>
 ...
 * 🎛️ 시간 제어 패널 (관리자용)
 */
export function TimeRotationControlPanel({
  className,
}: {
  className?: string;
}) {
