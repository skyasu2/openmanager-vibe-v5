...
const cardData: FeatureCard[] = [
  {
    ...
    detailedContent: {
      ...
      technologies: [
        '🤖 오픈소스 6개: TensorFlow.js, Simple-Statistics, Natural, Compromise, Fuse.js, ML-Matrix',
        '🧮 커스텀 5개: MCP Query, MCP Test, Hybrid, Unified, Custom NLP',
        '🗣️ 한국어 특화: korean-js 형태소, hangul-js 조사 처리, 도메인 템플릿',
  ...
  },
  {
    ...
    detailedContent: {
      ...
      technologies: [
        ...
        '🧠 보조 AI: ChatGPT gpt codex, 구글 Jules',
