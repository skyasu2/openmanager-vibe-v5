...
const cardData: FeatureCard[] = [
  ...
  },
  {
    ...
    detailedContent: {
      overview:
        '차세대 AI 페어 프로그래밍 방법론입니다. Cursor AI + Claude Sonnet 3.7.2 조합으로 개발 속도 300% 향상, 코드 품질 A등급(85점) 달성. 자연어 명령으로 전체 개발 사이클을 자동화한 혁신적 워크플로우입니다.',
      features: [
        '🎯 AI 페어 프로그래밍: 아키텍처 설계부터 디버깅까지 AI와 실시간 협업',
        '📝 자연어 기반 개발: "사용자 인증 시스템 만들어줘" → 완전한 코드 생성',
        '🔍 MCP 도구 체인: filesystem, web-search, github 완전 자동화',
        '🚀 무중단 배포: Git 커밋 → 자동 테스트 → 빌드 → 배포 원클릭',
        '🧪 TDD 자동화: 테스트 케이스 자동 생성, 코드 검증, 리팩토링 제안',
