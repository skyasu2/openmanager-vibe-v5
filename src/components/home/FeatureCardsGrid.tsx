...
const cardData: FeatureCard[] = [
  {
    ...
    detailedContent: {
      ...
      features: [
        ...
        '📈 Simple-Statistics v7.8: 10,000+/초 통계 계산, 95% 정확도 Z-score 분석',
        '🗣️ 한국어 AI 특화: 조사 처리, 의도 분류 90%, 서버 모니터링 도메인 어휘',
        '⚡ 스마트 라우팅: 4중 폴백 시스템, 85% 캐시 적중률, 50% 응답 단축',
      ],
      technologies: [
        '🤖 Master AI Engine v4.0, MCP Query Engine, TensorFlow.js v4.22, Simple-Statistics v7.8',
        '🔗 MCP 통합: mcp-filesystem, mcp-duckduckgo-search, mcp-sequential-thinking',
        '🧠 AI 모델: Natural NLP, Compromise.js, Fuse.js, ML-Matrix, Korean NLP Suite',
        '🗣️ 한국어 특화: korean-js 형태소, hangul-js 조사 처리, 도메인 템플릿 90% 정확도',
        '⚡ 성능 최적화: 지연 로딩(2초), 메모리 압축(40% 절약), 병렬 처리(100+ QPS)',
        '🔄 4중 폴백: MCP→TensorFlow→Statistics→Hybrid, 100% 가용성 보장',
      ],
    },
    requiresAI: true,
    isAICard: true,
  ...
  },
  {
    ...
    detailedContent: {
      ...
      features: [
        ...
        '⚡ 백그라운드 5%: 구글 Jules - 대규모 처리 및 자동화 작업',
        '📊 검증된 성과: 버그 60% 감소, 코드 품질 95% 향상, 개발 속도 300% 증가',
      ],
      technologies: [
        '🎯 Cursor AI (80%): Claude 4 Sonnet, 200K+ 토큰 컨텍스트, MCP 통합',
        '🔍 MCP Tools 3종: mcp-filesystem, mcp-duckduckgo-search, mcp-sequential-thinking',
        '🧠 ChatGPT (15%): GPT Codex, 브레인스토밍, 아키텍처 설계',
        '🤖 Google Jules (5%): AI 워크플로우 자동화, GitHub 연동, 클라우드 VM',
        '📊 검증 성과: 개발 효율성 300%, 코드 품질 95%, 빌드 성공률 100%',
        '🔄 하이브리드 전략: 상황별 AI 모델 선택, 최적 워크플로우 자동화',
      ],
    },
    requiresAI: false,
    isSpecial: true,
