...
const FeatureCard = ({ feature }: { feature: FeatureCardData }) => {
  ...
  return (
    <div className="group relative">
      <div className="absolute -inset-1 rounded-lg bg-gradient-to-r from-gray-200 to-gray-300 opacity-25 blur-sm transition duration-300 group-hover:opacity-100"></div>
      <div className="relative rounded-lg bg-white p-6 shadow-xs transition-all duration-300 hover:shadow-md">
        <div className="mb-4 flex items-start justify-between">
          <div
            className={`rounded-lg bg-gradient-to-r p-3 ${colorClasses[feature.color as keyof typeof colorClasses]} shadow-xs`}
          >
