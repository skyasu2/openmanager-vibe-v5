...
async function getSystemInfo() {
    ...
    try {
        ...
        systemInfo.memoryUsage = {
            ...
            usedPercent: ((systemInfo.totalMemory - systemInfo.freeMemory) / systemInfo.totalMemory) * 100,
...
async function getMCPStatus() {
    return new Promise((resolve) => {
        exec('curl -s http://localhost:10000/health || echo "MCP_OFFLINE"', (error, stdout, stderr) => {
