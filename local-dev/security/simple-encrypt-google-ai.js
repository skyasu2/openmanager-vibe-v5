...
async function main() {
    ...
    try {
        ...
        console.log(`${colors.green}✅ 복호화 테스트가 성공했습니다.${colors.reset}`);
        ...
        console.log(`   ${colors.magenta}src/config/google-ai-config.ts${colors.reset}`);

        console.log(`\n${colors.cyan}🔑 암호화 정보:${colors.reset}`);
        console.log(`   팀 비밀번호: ${colors.bright}${TEAM_PASSWORD}${colors.reset}`);
