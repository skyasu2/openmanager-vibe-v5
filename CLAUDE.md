...
**비용**: 총 $20/월 (Codex만 유료, 나머지 무료)

| AI | 요금제 | 인증 | 응답속도 | 특화 분야 |
|-----|--------|------|----------|----------|
| **Codex** | ChatGPT Plus ($20) | API Key | 2초 | 실무 버그 수정 |
| **Gemini** | OAuth 무료 (60 RPM) | OAuth | 11초 | 아키텍처 설계 |
| **Qwen** | OAuth 무료 (60 RPM) | OAuth | 6초 | 성능 최적화 |

### 사용 방법 (간단) ⭐

**사용자는 "AI 교차검증" 키워드만 사용**:
```
...
1. "AI 교차검증" 키워드 감지
2. 서브에이전트 자동 호출
3. 3-AI 병렬 실행 → 분석 → Decision Log 작성
4. 결과 보고
