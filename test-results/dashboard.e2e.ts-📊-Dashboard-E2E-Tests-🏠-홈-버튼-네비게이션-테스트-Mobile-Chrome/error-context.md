...
- Name: 📊 Dashboard E2E Tests >> 🏠 홈 버튼 네비게이션 테스트
- Location: D:\cursor\openmanager-vibe-v5\openmanager-vibe-v5\e2e\dashboard.e2e.ts:82:7
...
Call log:
  ...
  - waiting for getByRole('button', { name: '홈으로 이동' })
    ...
    at D:\cursor\openmanager-vibe-v5\openmanager-vibe-v5\e2e\dashboard.e2e.ts:85:30
```
