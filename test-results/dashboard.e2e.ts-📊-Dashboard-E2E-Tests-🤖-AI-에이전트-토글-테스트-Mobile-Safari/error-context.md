...
- Name: 📊 Dashboard E2E Tests >> 🤖 AI 에이전트 토글 테스트
- Location: D:\cursor\openmanager-vibe-v5\openmanager-vibe-v5\e2e\dashboard.e2e.ts:59:7
...
Locator: getByRole('button', { name: /ai 에이전트/i })
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByRole('button', { name: /ai 에이전트/i })

    at D:\cursor\openmanager-vibe-v5\openmanager-vibe-v5\e2e\dashboard.e2e.ts:62:31
```
...
- main:
  ...
  - text: Vibe Coding
  - paragraph:
    - text: GPT/Claude + Cursor AI 협업 개발
    - strong: 경량화 AI (No LLM Cost)
    - text: •
    - strong: 도메인 특화
    - text: •
    - strong: 확장성
  - paragraph: Copyright(c) 저작자
