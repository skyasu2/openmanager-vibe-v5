...
- Name: 📊 Dashboard E2E Tests >> 📱 반응형 디자인 테스트
- Location: D:\cursor\openmanager-vibe-v5\openmanager-vibe-v5\e2e\dashboard.e2e.ts:96:7
...
Call log:
  ...
  - waiting for locator('[role="status"][aria-label="서버 통계"]')
    ...
    at D:\cursor\openmanager-vibe-v5\openmanager-vibe-v5\e2e\dashboard.e2e.ts:99:71
```
