...
describe('GoogleOAuthService', () => {
    ...
    describe('Token Exchange', () => {
        it('should exchange authorization code for access token', async () => {
            ...
            const result = await googleOAuthService.exchangeCodeForToken('mock-auth-code');
    ...
    describe('User Profile Retrieval', () => {
        it('should fetch user profile with access token', async () => {
            ...
            const result = await googleOAuthService.getUserProfile('mock-access-token');

            expect(mockFetch).toHaveBeenCalledWith('https://www.googleapis.com/oauth2/v1/userinfo', {
                headers: {
    ...
    describe('State Management (CSRF Protection)', () => {
        it('should verify matching state', () => {
            ...
            expect(mockSessionStorage.getItem).toHaveBeenCalledWith('google_oauth_state');
            expect(mockSessionStorage.removeItem).toHaveBeenCalledWith('google_oauth_state');
            expect(isValid).toBe(true);
        });
