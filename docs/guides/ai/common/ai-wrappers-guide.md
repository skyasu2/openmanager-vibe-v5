# 🤖 AI Wrappers 통합 가이드 v4.0.0

**OpenManager VIBE 프로젝트 전용** | 최종 업데이트: 2026-01-08

> 2개 AI Wrapper (Codex, Gemini)의 사용법과 v4.0.0 2-AI 단순화 시스템
>
> **Note**: Qwen 제거 (2026-01-07) - 평균 201초 응답, 13.3% 실패율로 인해 2-AI로 단순화
...
1. [빠른 시작](#-빠른-시작)
2. [2개 Wrapper 비교](#-2개-wrapper-비교)
3. [v4.0.0 개선사항](#-v400-개선사항)
4. [사용 방법](#-사용-방법)
5. [트러블슈팅](#-트러블슈팅)
...
|------|-------|--------|
| **버전** | v4.0.0 | v4.0.0 |
| **주 용도** | 코드 리뷰 (Primary) | 코드 리뷰 (Secondary) |
| **모델** | GPT-5 기반 | Gemini 2.5 Pro |
| **응답 속도** | ~20초 | ~10초 |
| **선택 비율** | 50% (1/2) | 50% (1/2) |
| **토큰 추적** | ✅ 있음 | ❌ 없음 |
| **고유 기능** | 토큰 로깅 | ImportProcessor 필터 |
| **타임아웃** | 600초 | 600초 |
| **안전장치** | ✅ v4.0.0 | ✅ v4.0.0 |

### 언제 어떤 Wrapper를 사용하나요?

- **Codex**: 코드 리뷰 (2-AI 순환, Primary) - 실무 검증 전문
- **Gemini**: 코드 리뷰 (2-AI 순환, Secondary) + Rate limit 폴백
...
Qwen 제거 후 2개 Wrapper로 단순화된 시스템:
...
3. 2-AI 순환 (Codex ↔ Gemini) 1:1 비율
4. Rate limit 발생 시 다른 AI로 폴백
...
**버전**: v4.0.0 (Codex & Gemini)
**상태**: 프로덕션 운영 중 ✅
**순환**: 2-AI 1:1 순환 (Codex ↔ Gemini)
