...
- **Backend**: Vercel Edge Functions (Node.js), PostgreSQL
...
# AI 엔진 설정 (선택사항)
# Vercel 독립형 구조에서는 별도 Python 서비스가 필요 없습니다
```
