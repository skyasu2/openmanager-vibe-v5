---
id: docs-structure-improvement-plan
title: Documentation Structure Improvement Plan
keywords: [docs, structure, improvement, refactoring, organization]
priority: high
ai_optimized: true
updated: '2025-12-19'
version: 'v5.83.1'
...
| `docs/planning/archive/` | 빈 폴더 | 삭제 권장 |
...
| Phase | 작업 | 우선순위 | 리스크 | 예상 시간 |
|:------|:-----|:--------:|:------:|:---------:|
| 1 | 빈 디렉토리 삭제 | **높음** | 낮음 | 5분 |
| 2 | Claude-Code 문서 통합 | **중간** | 중간 | 30분 |
| 3 | Testing 위치 검토 | 낮음 | - | 토론 |
| 4 | 네이밍 표준화 | 낮음 | 높음 | 1시간+ |
| 5 | Architecture 단순화 | 낮음 | 높음 | 2시간+ |
