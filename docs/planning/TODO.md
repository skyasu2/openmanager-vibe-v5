...
| 작업 | 완료일 | 문서 |
|------|--------|------|
| **Code Interpreter** | **2025-12-18** | **Browser-based Python (Pyodide), AI 응답에서 코드 실행 지원** |
| **GraphRAG 하이브리드 검색** | **2025-12-18** | **Vector + Text (BM25) + Graph 3중 검색, Supabase 마이그레이션 완료** |
...
| 멀티모달 (텍스트) | 2025-12-12 | ❌ 불필요 판정 (서버 모니터링 특성) |
| 멀티모달 (Audio I/O) | 2025-12-18 | ❌ 불필요 판정 (서버 모니터링 특성상 음성 불필요) |
