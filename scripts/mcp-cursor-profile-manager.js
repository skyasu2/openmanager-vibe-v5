...
사용법:
  node scripts/mcp-cursor-profile-manager.js [명령] [프로필]
...
예시:
  node scripts/mcp-cursor-profile-manager.js cursor:switch full-dev
  node scripts/mcp-cursor-profile-manager.js cursor:enhance
`);
}
...
function listProfiles() {
  ...
  console.log('\n💡 사용법: node scripts/mcp-cursor-profile-manager.js cursor:switch <프로필명>\n');
}
