#!/usr/bin/env node
/**
 * Phase 6: Update imports for security/ folder reorganization
 *
 * 이동된 파일 (1개):
...
const importMappings = [
  { from: '@/lib/rate-limiter', to: '@/lib/security/rate-limiter' },
];
...
// Main execution
console.log('🔄 Phase 6: security/ 폴더 import 경로 업데이트 시작...\n');
