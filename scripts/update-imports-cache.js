#!/usr/bin/env node
/**
 * Phase 3: Update imports for cache/ folder reorganization
 *
 * 이동된 파일 (2개):
 * - cache-helper.ts → cache/cache-helper.ts
 * - unified-cache.ts → cache/unified-cache.ts
 *
 * 검색 경로:
 * - src/app/
 * - src/components/
...
const importMappings = [
  { from: '@/lib/cache-helper', to: '@/lib/cache/cache-helper' },
  { from: '@/lib/unified-cache', to: '@/lib/cache/unified-cache' },
];
...
// Main execution
console.log('🔄 Phase 3: cache/ 폴더 import 경로 업데이트 시작...\n');
