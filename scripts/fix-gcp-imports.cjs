...
filesToFix.forEach(filePath => {
  ...
  if (content.includes("from '../gcp/BaselineStorageService'") || 
...
// 추가 수정 필요 파일들
console.log('\n📋 추가 수정 필요:');
console.log('1. src/app/api/system/sync-data/route.ts - supabaseStart, validationStart 변수');
console.log('2. src/components/unified-profile/UnifiedProfileButton.tsx - toggleAI 메서드');
