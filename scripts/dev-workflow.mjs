...
class DevWorkflow {
  ...
  async testConnections() {
    ...
    const tests = [
      {
        name: '로컬 개발 서버',
        url: CONFIG.LOCAL_DEV + CONFIG.ENDPOINTS.health,
      },
      {
        name: '로컬 MCP 서버',
        url: CONFIG.LOCAL_MCP + CONFIG.ENDPOINTS.health,
      },
      {
        name: 'MCP 상태 API',
        url: CONFIG.LOCAL_DEV + CONFIG.ENDPOINTS.mcpStatus,
      },
      {
        name: 'AI 엔진 상태',
        url: CONFIG.LOCAL_DEV + CONFIG.ENDPOINTS.aiEngines,
      },
    ];
  ...
  async testProductionConnections() {
    ...
    const prodTests = [
      ...
      {
        name: 'Vercel 메인 앱',
        url: CONFIG.VERCEL_PROD + CONFIG.ENDPOINTS.health,
      },
      {
        name: 'Vercel → GCP 통신',
        url: CONFIG.VERCEL_PROD + CONFIG.ENDPOINTS.mcpStatus,
      },
    ];
...
switch (command) {
  ...
  default:
    console.log(
      '사용법: node scripts/dev-workflow.mjs [dev|deploy:render|deploy:vercel|test:production|test:local]'
    );
}
