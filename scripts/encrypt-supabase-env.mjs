...
const supabaseEnvVars = {
  ...
  // 🔗 연결 URL들
  POSTGRES_URL:
    'postgres://postgres.your_supabase_project_id_here:SENSITIVE_INFO_REMOVED@aws-0-ap-southeast-1.pooler.supabase.com:6543/postgres?sslmode=require&supa=base-pooler.x',
  POSTGRES_PRISMA_URL:
    'postgres://postgres.your_supabase_project_id_here:SENSITIVE_INFO_REMOVED@aws-0-ap-southeast-1.pooler.supabase.com:6543/postgres?sslmode=require&supa=base-pooler.x',
...
try {
  ...
  const encryptedConfig =
    enhancedCryptoManager.encryptEnvironment(supabaseEnvVars);
